...
define('dummy/ember-html5-draggable/tests/modules/ember-html5-draggable/components/sortable-group.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('modules/ember-html5-draggable/components/sortable-group.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'modules/ember-html5-draggable/components/sortable-group.js should pass jshint.\nmodules/ember-html5-draggable/components/sortable-group.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\nmodules/ember-html5-draggable/components/sortable-group.js: line 2, col 1, \'import\' is only available in ES6 (use esnext option).\nmodules/ember-html5-draggable/components/sortable-group.js: line 3, col 1, \'import\' is only available in ES6 (use esnext option).\nmodules/ember-html5-draggable/components/sortable-group.js: line 4, col 1, \'const\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 4, col 1, \'destructuring expression\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 6, col 1, \'export\' is only available in ES6 (use esnext option).\nmodules/ember-html5-draggable/components/sortable-group.js: line 17, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 30, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 34, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 35, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 36, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 37, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 46, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 48, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 49, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 53, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 87, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 120, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 122, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 126, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 132, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 139, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 144, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 150, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 152, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 162, col 11, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 182, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 184, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 194, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 199, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 216, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 229, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 231, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 232, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 233, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 234, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 263, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 272, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 287, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 288, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 289, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 296, col 42, \'draggedModel\' used out of scope.\n\n42 errors');
  });
});
...
if (!runningTests) {
  require("dummy/app")["default"].create({"name":"ember-html5-draggable","version":"1.0.5+b1f9fc25"});
}
