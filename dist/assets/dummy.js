...
define('dummy/ember-html5-draggable/tests/modules/ember-html5-draggable/components/sortable-group.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('modules/ember-html5-draggable/components/sortable-group.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'modules/ember-html5-draggable/components/sortable-group.js should pass jshint.\nmodules/ember-html5-draggable/components/sortable-group.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\nmodules/ember-html5-draggable/components/sortable-group.js: line 2, col 1, \'import\' is only available in ES6 (use esnext option).\nmodules/ember-html5-draggable/components/sortable-group.js: line 3, col 1, \'import\' is only available in ES6 (use esnext option).\nmodules/ember-html5-draggable/components/sortable-group.js: line 4, col 1, \'const\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 4, col 1, \'destructuring expression\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 6, col 1, \'export\' is only available in ES6 (use esnext option).\nmodules/ember-html5-draggable/components/sortable-group.js: line 15, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 28, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 32, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 33, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 34, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 35, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 44, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 46, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 47, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 51, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 81, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 110, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 114, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 120, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 127, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 132, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 139, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 144, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 161, col 7, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 174, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 178, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 179, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 181, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 182, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 201, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 209, col 3, \'concise methods\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 222, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 223, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 224, col 5, \'let\' is available in ES6 (use esnext option) or Mozilla JS extensions (use moz).\nmodules/ember-html5-draggable/components/sortable-group.js: line 231, col 42, \'draggedModel\' used out of scope.\n\n36 errors');
  });
});
...
if (!runningTests) {
  require("dummy/app")["default"].create({"name":"ember-html5-draggable","version":"1.0.2+386a1cfe"});
}
